...
const (
	...
	MAV_CMD_DO_REBOOT MAV_CMD = 50200
	MAV_CMD_DO_START_FIRMWARE_UPDATE MAV_CMD = 50201
	MAV_CMD_DO_START_GYRO_CAL MAV_CMD = 50202
	MAV_CMD_DO_START_MAG_CAL_2D MAV_CMD = 50203
	MAV_CMD_DO_START_MAG_CAL_3D MAV_CMD = 50206
	MAV_CMD_DO_STOP_MAG_CAL_3D MAV_CMD = 50207
	// Set the fault response for the given fault
	MAV_CMD_DO_SET_FAULT_RESPONSE MAV_CMD = 50204
	// Set the fault response parameters for the mission
	MAV_CMD_DO_SET_FAULT_RESPONSE_PARAMS MAV_CMD = 50205
	// Immediatedly start a generic mission
	MAV_CMD_DO_GENERIC_COMMAND MAV_CMD = 50208
	// Immediately start a zig-zag mission for lateral model detection
	MAV_CMD_DO_ZIG_ZIG_COMMAND MAV_CMD = 50209
	// Immediately start a file based mission
	MAV_CMD_DO_FILE_MISSION_COMMAND MAV_CMD = 50210
	// Save uploaded mission to disk for execution with MAV_CMD_DO_FILE_MISSION_COMMAND
	MAV_CMD_DO_SET_FILE_MISSION_COMMAND MAV_CMD = 50211
	// Instruct the vehicle to randomly traverse the specified area. Shape my be circle or polygon
	MAV_CMD_DO_MILLING MAV_CMD = 50212
	// Defines a vertex for a milling polygon. For a given polygon, all vertices should be sent monotonically increasing immediately preceding the corresponding MAV_CMD_DO_MILLING message. MAV_CMD_DO_SET_MILLING_POLYGON_VERTEX must only be sent if the corresponding MAV_CMD_DO_MILLING shape is polygon
	MAV_CMD_DO_SET_MILLING_POLYGON_VERTEX MAV_CMD = 50213
	// Immediately start a magothy custom 0 mission. This message will have vehicle specific meaning
	MAV_CMD_DO_MAGOTHY_CUSTOM_0 MAV_CMD = 50300
	// Immediately start a magothy custom 1 mission. This message will have vehicle specific meaning
	MAV_CMD_DO_MAGOTHY_CUSTOM_1 MAV_CMD = 50301
	// Immediately start a magothy custom 2 mission. This message will have vehicle specific meaning
	MAV_CMD_DO_MAGOTHY_CUSTOM_2 MAV_CMD = 50302
)
...
var labels_MAV_CMD = map[MAV_CMD]string{
	...
	MAV_CMD_DO_REBOOT: "MAV_CMD_DO_REBOOT",
	MAV_CMD_DO_START_FIRMWARE_UPDATE: "MAV_CMD_DO_START_FIRMWARE_UPDATE",
	MAV_CMD_DO_START_GYRO_CAL: "MAV_CMD_DO_START_GYRO_CAL",
	MAV_CMD_DO_START_MAG_CAL_2D: "MAV_CMD_DO_START_MAG_CAL_2D",
	MAV_CMD_DO_START_MAG_CAL_3D: "MAV_CMD_DO_START_MAG_CAL_3D",
	MAV_CMD_DO_STOP_MAG_CAL_3D: "MAV_CMD_DO_STOP_MAG_CAL_3D",
	MAV_CMD_DO_SET_FAULT_RESPONSE: "MAV_CMD_DO_SET_FAULT_RESPONSE",
	MAV_CMD_DO_SET_FAULT_RESPONSE_PARAMS: "MAV_CMD_DO_SET_FAULT_RESPONSE_PARAMS",
	MAV_CMD_DO_GENERIC_COMMAND: "MAV_CMD_DO_GENERIC_COMMAND",
	MAV_CMD_DO_ZIG_ZIG_COMMAND: "MAV_CMD_DO_ZIG_ZIG_COMMAND",
	MAV_CMD_DO_FILE_MISSION_COMMAND: "MAV_CMD_DO_FILE_MISSION_COMMAND",
	MAV_CMD_DO_SET_FILE_MISSION_COMMAND: "MAV_CMD_DO_SET_FILE_MISSION_COMMAND",
	MAV_CMD_DO_MILLING: "MAV_CMD_DO_MILLING",
	MAV_CMD_DO_SET_MILLING_POLYGON_VERTEX: "MAV_CMD_DO_SET_MILLING_POLYGON_VERTEX",
	MAV_CMD_DO_MAGOTHY_CUSTOM_0: "MAV_CMD_DO_MAGOTHY_CUSTOM_0",
	MAV_CMD_DO_MAGOTHY_CUSTOM_1: "MAV_CMD_DO_MAGOTHY_CUSTOM_1",
	MAV_CMD_DO_MAGOTHY_CUSTOM_2: "MAV_CMD_DO_MAGOTHY_CUSTOM_2",
}
